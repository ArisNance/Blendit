class AddCachedVotesToStories < ActiveRecord::Migration
  def self.up
    ...
    add_column :stories, :cached_weighted_total, :integer, :default => 0
    add_column :stories, :cached_weighted_average, :float, :default => 0.0
    ...
    add_index  :stories, :cached_weighted_total
    add_index  :stories, :cached_weighted_average
  ...
  def self.down
    ...
    remove_column :stories, :cached_weighted_total
    remove_column :stories, :cached_weighted_average
  end
end
